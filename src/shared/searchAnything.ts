...
const STATIC_CATALOG: SettingsSearchEntry[] = [
  ...
  },
  {
    ...
    description:
      'Use a verified summary for long-session compact. Built into Enso — no extra install. Falls back to default compact on failure. May be slower and use more tokens. Takes effect on the next session. Choose Auto/Fast/Balanced/Thorough and a dedicated summary model or follow the session model.',
  },
  {
